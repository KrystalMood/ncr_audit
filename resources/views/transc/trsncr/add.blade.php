...
<select name="iso" id="isoSelect" class="form-control form-control-lg custom-select-icon">
...
<div class="position-relative">
<select name="klausul" id="klausulSelect" class="form-control form-control-lg custom-select-icon">
...
<div class="position-relative">
<select name="kategori" class="form-control form-control-lg custom-select-icon">
<option>Major</option>
<option>Minor</option>
...
<div class="position-relative">
<select name="fishbone" class="form-control form-control-lg custom-select-icon">
...
<textarea name="corrective_action" rows="4" class="form-control"></textarea>
</div>

<div class="col-md-12 mb-4">
<label class="form-label">Corrections</label>
<textarea name="correction" rows="4" class="form-control"></textarea>
</div>
...
<p class="text-sm text-muted mb-0">Klik untuk upload bukti</p>
</div>
