...
<tr>
    ...
    <td>
        <input type="text" name="clause_number[]" class="form-control" placeholder="Contoh: 6.1" required>
    </td>

    <td>
        <input type="text" name="clause_name[]" class="form-control" placeholder="Nama Klausul" required>
    </td>

    <td>
        <input type="text" name="description[]" class="form-control" placeholder="Deskripsi Klausul">
    </td>
