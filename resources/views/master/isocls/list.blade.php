                ...
                <div class="card">
                    ...
                    <div class="px-4 py-2">
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="list_iso" class="table table-bordered table-striped align-items-center mb-0"
                                style="width:100%">
                                    ...
                                    @foreach ($dataList as $key => $row)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                {{-- VIEW --}}
                                                @if (isset($authorize))
                                                    <a href="{{ URL::to($url_menu . '/show/' . encrypt($row->idclauses)) }}"
                                                ...
                                                @if (isset($authorize) && $authorize->edit == '1')
                                                    <a href="{{ URL::to($url_menu . '/edit/' . encrypt($row->idclauses)) }}"
                                                ...
                                                @if (isset($authorize) && $authorize->delete == '1')
                                                    <form action="{{ url($url_menu . '/' . encrypt($row->idclauses)) }}"
            ...
            $('#btnPdf').click(function() {
                ...
                for (let iso in grouped) {
                    ...
                    doc.autoTable({
                        ...
                        startY: y,
                        head: [
                            ["No Klausul", "Nama Klausul", "Level", "Status"]
                        ],
                        body: grouped[iso],
                        styles: {
                            fontSize: 9
